...
btn5 = types.KeyboardButton('/WebcamVid\n')
...
##############################
# Подменю управления записью c web-камеры
##############################

video_submenu = types.ReplyKeyboardMarkup()
btn1 = types.KeyboardButton('/WebcamVid5')
btn2 = types.KeyboardButton('/WebcamVid10')
btn3 = types.KeyboardButton('/WebcamVid15')
btn4 = types.KeyboardButton('/CancelMain')
video_submenu.row(btn1)
video_submenu.row(btn2)
video_submenu.row(btn3)
video_submenu.row(btn4)
...
def webcam(command):
    bot.send_chat_action(adm, 'typing')
    bot.send_message(adm, '*Выберите длительность видео*', reply_markup=video_submenu, parse_mode='Markdown')
